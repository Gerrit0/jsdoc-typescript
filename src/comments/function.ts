...
import { hasJSDoc, getName, createDocComment, getComments, getTags, Logger } from '../utils'
...
export default function getCommentForFunction(node: ts.FunctionLike, namespace: string[]): string {
